            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <li>
                            <i class="fa fa-bullhorn fa-fw"></i> <a href="news_list.php">ข่าว</a>
                        </li>
                        <li class="active">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <form role="form">
                            ...
                            <div class="form-group">
                                <label>ผู้ลงข่าว</label>
                                <input class="form-control">
                            </div>

                            <div class="form-group">
                                <label>ผู้ดูแลข่าว</label>
                                <input class="form-control">
                            </div>

                            <br>
                            <a href="news_list.php">
                            <button type="button" class="btn btn-primary">กลับหน้าข่าว</button>
                            </a>
