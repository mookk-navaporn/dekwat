                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <i class="fa fa-calendar fa-fw"></i>  <a href="activity_list.php"></i> กิจกรรม</a>
                            </li>
                            <li class="active">
                                <i class="fa fa-edit"></i> เพิ่มกิจกรรม
                            </li>
                        </ol>
                    </div>
                </div>
                        ...
                        <form role="form">
                            ...
                            <div class="form-group">
                                    ...
                                    <select class="form-control">
                                        <option>ระหว่างรอลงทะเบียน</option>
                                        <option>สิ้นสุดกิจกรรม</option>
                                    </select>
                            </div>
                            ...
                            <br>
                            <button type="submit" class="btn btn-primary">เพิ่มกิจกรรม</button> &nbsp &nbsp
