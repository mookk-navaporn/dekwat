                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <i class="fa fa-user fa-fw"></i> <a href="user_list.php">ผู้เข้าร่วมกิจกรรม</a>
                            </li>
                            <li class="active">
                                <i class="fa fa-th-list  fa-fw"></i> กิจกรรมที่เคยเข้าร่วม
                            </li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <tr class="user_list">
                                        <td>1</td>
                                        <td>ขอเชิญทุกท่านร่วมปฏิบัติธรรม | ทอดผ้าป่าสร้างถนนขนาดมาตรฐานเข้าศูนย์ฯ และ เป็นเจ้าภาพเลี้ยงอาหารผู้ปฏิบัติธรรม</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
