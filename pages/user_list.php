    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-user fa-fw"></i> ผู้เข้าร่วมกิจกรรม
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h3>รายชื่อผู้เข้าร่วมกิจกรรม &nbsp 
                            <a href="user_add.php">
                                <button type="button" class="btn btn-sm btn-primary">เพิ่มผู้เข่าร่วมกิจกรรม</button>
                            </a>
                        </h3>
                        <br>
                            ...
                            <table class="table table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        ...
                                        <th>เบอร์โทรศัพท์</th>
                                        <th>E-mail</th>
                                        <th>จำนวนครั้งที่เคยเข้าร่วมกิจกรรม</th>
                                        <th></th>
                                    </tr>
                                    </thead>
                                <tbody>
                                    <tr class="user_list">
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-xs btn-info">กิจกรรมที่เคยเข้าร่วม</button>
                                            </a>
