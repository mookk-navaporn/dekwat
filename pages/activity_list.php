    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-calendar fa-fw"></i> กิจกรรม
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h3>รายละเอียดกิจกรรม &nbsp
                        <a href="activity_add.php">
                            <button type="button" class="btn btn-sm btn-primary">เพิ่มกิจกรรม</button>
                        </a>
                        </h3>
                            ...
                            <table class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th>หัวข้อกิจกรรม</th>
                                        <th>สถานะกิจกรรม</th>
                                        <th>วันทีเริ่มกิจกรรม</th>
                                        <th>วันที่สิ้นสุดกิจกรรม</th>
                                        <th>วันที่ลงกิจกรรม</th>
                                        <th>จำนวนที่เข้าร่วม / จำนวนที่รับ</th>
                                        <th></th>

                                    </tr>
                                </thead>
                                <tbody>
                                    <tr class="detailAdmin">
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        ...
                                        <td></td>
                                        <td>
                                            <a href="activity_user.php">
                                            <button type="button" class="btn btn-xs btn-warning">รายชื่อผู้ลงทะเบียน</button>
                                            </a>
                                            <a href="activity_detail.php">
                                            <button type="button" class="btn btn-xs btn-info">รายละเอียด</button>
                                            </a>
                                            <a href="activity_edit.php">
                                            <button type="button" class="btn btn-xs btn-success">แก้ไข</button>
                                            </a>
                                            <button type="button" class="btn btn-xs btn-danger" onclick="confirm('ยืนยันการลบ')">ลบ</button>
                                        </td>
                                        </tr>
                                </tbody>
                            </table>
