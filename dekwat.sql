...
-- Schema dekwat
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `dekwat` DEFAULT CHARACTER SET utf8 ;
USE `dekwat` ;

-- -----------------------------------------------------
-- Table `dekwat`.`member`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dekwat`.`member` (
...
-- Table `dekwat`.`admin`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dekwat`.`admin` (
...
-- Table `dekwat`.`event`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dekwat`.`event` (
  ...
  CONSTRAINT `fk_event_admin1`
    ...
    REFERENCES `dekwat`.`admin` (`admin_Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `dekwat`.`news`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dekwat`.`news` (
...
-- -----------------------------------------------------
-- Table `dekwat`.`authority`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dekwat`.`authority` (
...
-- Table `dekwat`.`audio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dekwat`.`audio` (
...
-- -----------------------------------------------------
-- Table `dekwat`.`history_register`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dekwat`.`history_register` (
  ...
  CONSTRAINT `fk_history_register_member1`
    ...
    REFERENCES `dekwat`.`member` (`member_Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_history_register_event1`
    FOREIGN KEY (`event_event_Id`)
    REFERENCES `dekwat`.`event` (`event_Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `dekwat`.`tag`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dekwat`.`tag` (
...
-- -----------------------------------------------------
-- Table `dekwat`.`audio_tag`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dekwat`.`audio_tag` (
  ...
  CONSTRAINT `fk_audio_tag_audio1`
    ...
    REFERENCES `dekwat`.`audio` (`audio_Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_audio_tag_tag1`
    FOREIGN KEY (`tag_tag_Id`)
    REFERENCES `dekwat`.`tag` (`tag_Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `dekwat`.`admin_manage_member`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dekwat`.`admin_manage_member` (
...
-- Table `dekwat`.`role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dekwat`.`role` (
...
-- -----------------------------------------------------
-- Table `dekwat`.`role_authority`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dekwat`.`role_authority` (
  ...
  CONSTRAINT `fk_role_authority_authority1`
    ...
    REFERENCES `dekwat`.`authority` (`author_Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_role_authority_role1`
    FOREIGN KEY (`role_role_Id`)
    REFERENCES `dekwat`.`role` (`role_Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `dekwat`.`event_picture`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dekwat`.`event_picture` (
